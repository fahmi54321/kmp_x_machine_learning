...
import com.kmpxmachinelearning.shared.core.error.Failure
...
sealed class RequestState<out T> {
    ...
    data class ErrorV2(val failure: Failure) : RequestState<Nothing>()
    ...
    fun getErrorV2Message(): String = (this as ErrorV2).failure.message
}
